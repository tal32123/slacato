...
export const BrowserPublic = (): MethodDecorator & ClassDecorator =>
  SetMetadata(ENDPOINT_ACCESS, 'browser_public' satisfies EndpointAccess);

/** Permits read-only machine traffic such as liveness and readiness probes. */
export const NonBrowserPublic = (): MethodDecorator & ClassDecorator =>
  SetMetadata(ENDPOINT_ACCESS, 'non_browser_public' satisfies EndpointAccess);
