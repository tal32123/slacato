...
/** Reauthorizes current content and immutable manifest membership without revealing denial causes. */
export class PostgresCitationResolver implements CitationResolver {
  /** Configures citation resolution against the authoritative evidence database. */
