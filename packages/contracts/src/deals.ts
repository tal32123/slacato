...
export const dealSummarySchema = z.object({
  ...
  latestRun: z.object({ status: runStatusSchema, updatedAt: isoDateTimeSchema }).strict().nullable()
}).strict();
...
export const evidenceDetailSchema = z.object({
  ...
  sourceType: z.enum(['gong_summary', 'gong_transcript', 'policy', 'pricing', 'salesforce', 'slack']),
...
export const stakeholderViewSchema = z.object({
...
export const recommendedActionViewSchema = z.object({
...
export const reviewWarningViewSchema = z.object({
...
export const dealBriefViewSchema = z.object({
